...
# for Kibana 5.x
package_download_url="https://artifacts.elastic.co/downloads/${service_name}/${service_name}-${service_version}-linux-x86_64.tar.gz"
...
#log_debug "[${service_name}] install ${service_name} x-pack ..."
#${service_home_root}/bin/${service_name}-plugin install --quiet x-pack
